package com.sogeti.ptm.app.controllers;


import com.sogeti.ptm.app.dto.NewUserDTO;
import com.sogeti.ptm.app.dto.UserInfoDTO;
import com.sogeti.ptm.app.model.User;
import com.sogeti.ptm.app.services.UserService;
...
public class UserController {
    ...
    public UserInfoDTO getUserInfo(Principal principal) {
        ...
        Long todaysCalories = 9999L;//userService.findTodaysCaloriesForUser(principal.getName());
