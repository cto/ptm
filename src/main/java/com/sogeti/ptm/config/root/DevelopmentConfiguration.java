package com.sogeti.ptm.config.root;


import com.sogeti.ptm.app.init.TestDataInitializer;
...
public class DevelopmentConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DriverManagerDataSource dataSource) {
        ...
        entityManagerFactoryBean.setPackagesToScan(new String[]{"com.sogeti.ptm.app.model"});
